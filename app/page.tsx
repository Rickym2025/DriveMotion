    ...
    <div className="min-h-screen bg-[#050505] text-slate-200 font-sans selection:bg-cyan-500/30 overflow-x-hidden relative pt-20">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        @keyframes gold-pulse {
          ...
          50% { box-shadow: 0 0 32px rgba(234, 179, 8, 0.65), inset 0 0 22px rgba(234, 179, 8, 0.4); border-color: rgba(234, 179, 8, 0.85); }
        }
        ...
        .gold-decoy-card {
          animation: gold-pulse 3.5s infinite ease-in-out;
        }
          ...
          <div className="bg-[#0a0a0c]/80 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
            ...
            <div className="mt-12 pt-8 border-t border-white/10 max-w-2xl mx-auto relative z-10">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-black py-6 rounded-xl flex items-center justify-center gap-3 transition-all disabled:opacity-50 shadow-[0_0_30px_rgba(34,211,238,0.25)] transform active:scale-95 text-xl sm:text-2xl"
              >
